...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../declarations/dbank */ "./src/declarations/dbank/index.js");
...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  if (document.getElementById("input-amout").value.length != 0) {
    await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.topUp(inputAmount);
  }

  if (document.getElementById("withdrawal-amount").value.length != 0) {
    await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.withdrawal(outputAmount);
  }

  await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.compound();
  ...
  const currentAmount = await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.checkBalance();
  document.getElementById("value").innerText = Math.round(currentAmount * 100) / 100;
